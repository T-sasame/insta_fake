<template>
    <div class="container">
        <div class="postsToppage col-md-12">
            <div class="row">
                <div class="col-md-6" v-for="post in childPosts.data" :key="post.id">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="image">
                        ...
                        <div class="col-md-4">
                            <a :href=" '/userpage/' + post.name">{{ post.name }}</a><hr color="#c0c0c0">
                            <p v-if=" post.comment.length <= 120 ">{{ post.comment }}</p>
                            <p v-else>{{ post.comment.substring(0,120) + "‥" }}</p>
...
export default {
    ...
    methods: {
        ...
        infinite($state) {
            axios.get('/data/posts/top?page=' + this.postsPage)
            .then(res => {
